...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Jersey</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                        <li class="breadcrumb-item active">Product</li>
                        <li class="breadcrumb-item active">Edit Jersey</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <form method="POST" action="/store/{{ $product->id }}" enctype="multipart/form-data">
            @method('put')
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label for="nama">Nama</label>
                    <input value="{{ $product->nama }}" type="name" class="form-control" id="nama" name="nama" placeholder="Masukan Nama Product">
                </div>
                <div class="form-group">
                    <label for="harga">Harga</label>
                    <input value="{{ $product->harga }}" type="number" class="form-control" id="harga" name="harga" placeholder="Harga Product">
                </div>
                <div class="form-group">
