            ...
            <form method="post" action="/update/{{ $product->id }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input value="{{ $product->nama }}" type="name" class="form-control" id="nama"
                            name="nama" placeholder="Masukan Nama Product">
                    </div>
                    <div class="form-group">
                        <label for="harga">Harga</label>
                        <input value="{{ $product->harga }}" type="number" class="form-control" id="harga"
                            name="harga" placeholder="Harga Product">
                    </div>
                    <div class="form-group">
